 ...
 * 
 * This servlet is used to register a sender in data base as a new user of the sender app. 
 * 
 * @author Alfonso Cambero Lorenzo
 * @version 1.0
 * @since 2014-02-01
 */
public class RegisterSendersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegisterSendersServlet() {
        super();
	...
	/**
	 * This method receives sender's Google device token from a HttpPost request and store this information in the database.
     * 
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            Logger lgr = Logger.getLogger(RegisterSendersServlet.class.getName());
        ...
        try {
            ...
            String stm = "INSERT INTO senders (device) VALUES (?)";
